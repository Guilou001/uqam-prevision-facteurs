...
*Applications de modèles économiques* (ECO8086, UQAM). Il est rendu ici reproductible : données
...
5. **Estimer les six modèles** : la moyenne de tout le passé ; l'autorégressif direct d'ordre 4 ; le
   ...
   de FRED-MD en deux composantes principales, les directions qui expliquent le plus de leur
   variation commune. L'ARDL ajoute les demandes d'assurance chômage et l'emploi salarié. Le VAR
   traite le chômage et les demandes d'assurance chômage comme deux variables qui s'expliquent
   mutuellement.
...
dépendent entièrement du millésime substitué, et il passe de 0,938 à 0,9998, soit le niveau du
repère.
...
réelles ». La courbe verte, sans la Covid, passe sous la jaune sur 38 des 39 mois dessinés, et c'est
ce décalage vers le bas qui la rapproche du réalisé. Dans le cadre de la moyenne historique les deux
se superposent, l'écart n'y valant que 0,0033 point.
...
Durées mesurées sur un processeur Apple M5 Pro : **89 secondes** pour `pmf lab`, dont 62 pour l'ARMA,
...
Données : Federal Reserve Bank of St. Louis, série UNRATE et base FRED-MD de McCracken et Ng,
téléchargées par script et jamais commitées. Code sous licence MIT.
